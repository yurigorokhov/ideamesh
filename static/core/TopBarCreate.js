  ...
  define([], function() {
    ...
    return TopBarCreate = (function(_super) {
      ...
      TopBarCreate.prototype.render = function() {
        ...
        $openNodeCreationPopout.click((function(_this) {
          return function() {
        ...
        $openLinkCreationPopout.click((function(_this) {
          return function() {
        ...
        this.$createLinkButton.click((function(_this) {
          return function() {
        ...
        $nodeHolder.focus((function(_this) {
          return function() {
        ...
        $linkHolder.focus((function(_this) {
          return function() {
        ...
        this.graphView.on("view:click", (function(_this) {
          return function() {
      ...
      TopBarCreate.prototype.createNode = function() {
        ...
        if (nodeObject[0] && (_.size(nodeObject[1]) > 1 || confirm("The node you are creating has no information associated with it. Do you really want to proceed?"))) {
          ...
          return this.dataController.nodeAdd(nodeObject[1], (function(_this) {
