...
(function() {
  ...
  define([], function() {
    ...
    LinkFilter = (function(_super) {
      ...
      function LinkFilter() {
        return LinkFilter.__super__.constructor.apply(this, arguments);
      }
      ...
      LinkFilter.prototype.filter = function(links) {
        return _.filter(links, (function(_this) {
    ...
    return GraphView = (function(_super) {
      ...
      GraphView.prototype.render = function() {
        ...
        this.linkStrength = (function(_this) {
          return function(link) {
        ...
        this.currentScale = 1;
        zoomCapture.call(zoom.on("zoom", (function(_this) {
          return function() {
            if (translateLock) {
              return;
            }
        ...
        $(this.el).on("dblclick", (function(_this) {
          return function(e) {};
        })(this));
        this.addCentering();
        return this;
      ...
      GraphView.prototype.update = function() {
        ...
        linkEnter = link.enter().append("line").attr("class", "link").attr("stroke", (function(_this) {
          return function(d) {
            return getLinkColor(d);
          };
        })(this)).attr('marker-end', function(link) {
          return 'url(#Triangle)';
        ...
        linkEnter.on("click", (function(_this) {
        ...
        link.exit().remove();
        link.attr("stroke-width", (function(_this) {
          return function(link) {
        ...
        nodeEnter.append("text").attr("dx", function(d) {
          return 4 + getSize(d);
        }).attr("dy", ".35em").text((function(_this) {
          return function(d) {
        ...
        nodeEnter.append("circle").attr("r", (function(_this) {
          return function(d) {
            return getSize(d);
          };
        })(this)).attr("cx", 0).attr("cy", 0).attr("stroke", (function(_this) {
          return function(d) {
            return getColor(d);
          };
        })(this)).attr("fill", "white").attr("stroke-width", 3);
        clickSemaphore = 0;
        nodeEnter.on("click", (function(_this) {
          return function(datum, index) {
      ...
      GraphView.prototype.addCentering = function() {
        var translateParams;
        translateParams = [0, 0];
        this.on("enter:node:rightclick", (function(_this) {
          return function(node) {
        ...
        return this.on("enter:link:rightclick", (function(_this) {
          return function(link) {
