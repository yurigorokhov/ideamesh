  ...
  define([], function() {
    ...
    return AddNode = (function(_super) {
      ...
      AddNode.prototype.init = function(instances) {
        ...
        $('#add-person-button').click((function(_this) {
          return function() {
        ...
        $('#add-project-button').click((function(_this) {
          return function() {
            return _this.createNode({
              "name": "",
              "url": "",
        ...
        $('#add-theme-button').click((function(_this) {
          return function() {
            return _this.createNode({
              "name": "",
              "description": "",
        ...
        return $('#add-other-button').click((function(_this) {
          return function() {
            return _this.createNode({
              "name": "",
              "url": "",
