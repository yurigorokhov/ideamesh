  ...
  define([], function() {
    ...
    return NodeEdit = (function(_super) {
      ...
      NodeEdit.prototype.init = function(instances) {
        ...
        this.listenTo(instances["KeyListener"], "down:80", (function(_this) {
          return function() {
      ...
      NodeEdit.prototype.update = function() {
        ...
        if (!this.buildingLink) {
          ...
          return _.each(selectedNodes, (function(_this) {
      ...
      NodeEdit.prototype.editNode = function(node, nodeDiv, blacklist) {
        ...
        $nodeMoreFields.click((function(_this) {
          return function() {
            _this.addField(nodeInputNumber, "Node" + node['_id'] + "Edit");
            return nodeInputNumber = nodeInputNumber + 1;
          };
        })(this));
        colorEditingField = '<form action="#" method="post"> <div class="controlset">Color<input id="color' + node['_id'] + '" name="color' + node['_id'] + '" type="text" value="' + origColor + '"/></div> </form>';
        ...
        $nodeDelete.click((function(_this) {
          return function() {
        ...
        return $nodeCancel.click((function(_this) {
          return function() {
      ...
      NodeEdit.prototype.deleteNode = function(delNode, callback) {
        return this.dataController.nodeDelete(delNode, (function(_this) {
      ...
      NodeEdit.prototype.renderProfile = function(node, nodeDiv, blacklist, propNumber) {
        ...
        return nodeDiv.on("click", (function(_this) {
          return function() {
      ...
      NodeEdit.prototype.addLinker = function(node, nodeDiv) {
        ...
        $createLinkButton.click((function(_this) {
          return function() {
        ...
        return this.graphView.on("enter:node:click", (function(_this) {
          return function(clickedNode) {
            var link;
      ...
      NodeEdit.prototype.addSpokes = function(node, spokeHolder, maxSpokes) {
        ...
        if (spokes.length > 0) {
          ...
          for (_i = 0, _len = spokes.length; _i < _len; _i++) {
            ...
            $spokeDiv.on("click", (function(_this) {
              return function(e) {
                var clickedLink;
        ...
        if (maxSpokes < spokes.length) {
          ...
          return $showMoreSpokes.on("click", (function(_this) {
            return function(e) {
