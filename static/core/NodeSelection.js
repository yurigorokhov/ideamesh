  ...
  define([], function() {
    ...
    return Selection = (function(_super) {
      ...
      Selection.prototype.init = function(instances) {
        ...
        this.graphView.on("enter:node:shift:click", (function(_this) {
          return function(datum) {
            return _this.toggleSelection(datum);
          };
        })(this));
        this.graphView.on("enter:node:ctrl:click", (function(_this) {
          return function(datum) {
      ...
      Selection.prototype.selectConnectedComponent = function(node) {
        ...
        graph = {};
        lookup = {};
        _.each(this.graphModel.getNodes(), (function(_this) {
          return function(node) {
            graph[_this.nodeHash(node)] = {};
            return lookup[_this.nodeHash(node)] = node;
          };
        })(this));
        _.each(this.linkFilter.filter(this.graphModel.getLinks()), (function(_this) {
