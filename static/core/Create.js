  ...
  define([], function() {
    ...
    return Create = (function(_super) {
      ...
      Create.prototype.render = function() {
        ...
        $linkCreateSelectSourceButton.click((function(_this) {
          return function() {
        ...
        $linkCreateSelectTargetButton.click((function(_this) {
          return function() {
        ...
        this.graphView.on("view:rightclick", (function(_this) {
          return function() {
      ...
      Create.prototype.createLink = function() {
        ...
        if (linkProperties[0]) {
          ...
          return this.dataController.linkAdd(linkObject, (function(_this) {
            return function(linkres) {
