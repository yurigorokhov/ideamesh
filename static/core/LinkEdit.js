  ...
  define([], function() {
    ...
    return LinkEdit = (function(_super) {
      ...
      LinkEdit.prototype.init = function(instances) {
        ...
        this.listenTo(instances["KeyListener"], "down:16:80", (function(_this) {
          return function() {
      ...
      LinkEdit.prototype.update = function() {
        ...
        return _.each(selectedLinks, (function(_this) {
      ...
      LinkEdit.prototype.editLink = function(link, linkDiv, blacklist) {
        ...
        colorEditingField = '<form action="#" method="post"> <div class="controlset">Color<input id="color' + link['_id'] + '" name="color' + link['_id'] + '" type="text" value="' + origColor + '"/></div> </form>';
        ...
        $linkMoreFields.click((function(_this) {
          return function() {
        ...
        $linkDelete.click((function(_this) {
          return function() {
        ...
        return $linkCancel.click((function(_this) {
          return function() {
            return _this.cancelEditing(link, linkDiv, blacklist);
          };
        })(this));
      ...
      LinkEdit.prototype.deleteLink = function(delLink, callback) {
        return this.dataController.linkDelete(delLink, (function(_this) {
      ...
      LinkEdit.prototype.renderProfile = function(link, linkDiv, blacklist) {
        ...
        $linkDeselect.click((function(_this) {
          return function() {
            return _this.selection.toggleSelection(link);
          };
        })(this));
        _.each(link, (function(_this) {
        ...
        return $linkEdit.click((function(_this) {
          return function() {
