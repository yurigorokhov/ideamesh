    ...
    return MiniMap = (function(_super) {
      ...
      MiniMap.prototype.update = function() {
        ...
        if ((this.mostRecentNode !== void 0) && (_ref = this.mostRecentNode, __indexOf.call(this.model.getNodes(), _ref) >= 0)) {
          ...
          this.frame.append("circle").attr("class", "node").attr("stroke", "darkgrey").attr("stroke-width", 3).attr("fill", this.mostRecentNode.selected ? "steelblue" : "white").attr("cx", sub_width / 2 + central_width / 2).attr("cy", sub_height / 2 + central_width / 2).attr("r", central_width).on("click", (function(_this) {
            return function() {
